...
## Test: Fluxo de recuperação de senha

Passos rápidos para verificar manualmente o fluxo de "Esqueceu a senha?" implementado em `app/login.tsx`:

1. Instale dependências e inicie o app:
